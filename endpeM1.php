...
// Consulta para obtener la suma de 'preciou' en la tabla 'ordenmesa1' de la base de datos 'pruebar_demo'
$sqlSuma = "SELECT SUM(preciou) AS total FROM pruebar_demo.ordenmesa1";
...
header("Location: reiniciar_mesa1.php");
exit;
?>
