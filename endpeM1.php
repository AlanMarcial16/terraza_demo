...
// Consulta para obtener la suma de 'preciou' en la tabla 'ordenmesa1' de la base de datos 'pruebar'
$sqlSuma = "SELECT SUM(preciou) AS total FROM pruebar.ordenmesa1";
