            ...
            <div class="container mt-5 custom-container">
                ...
                <div class="row">
                    ...
                    <div style="text-align: left;">
                                    <a href="info_mesa8.php">
                                        <button class="btn btn-primary"><i class="fa1 fa fa-arrow-left"></i></button>
                                    </a>
                                    <h1 style="text-align: center;"><b>PAGAR - Mesa 8</b></h1>
                    </div>
                ...
                <!-- Mostrar los detalles de la mesa en la página -->
                                ...
                                <fieldset> 
                                    ...
                                    <div class="container">
                                        ...
                                        <br><br>  
                                        <h2 class="h2">Seleccione un método de pago</h2>
                                        <br><br>
                                        <form id="myForm" style="max-width:500px;margin:auto">
                                            <!-- COMIENZA EL SELECTOR DE PAGO -->
                                            <select class="form-control mb-3" id="pago" name="pago" placeholder="Método de Pago" onchange="redireccionar()">
                                                <option selected="selected">ELIGE UNA OPCIÓN</option>
                                                <option value="pagoeM8.php">EFECTIVO</option>
                                                <option value="pagotM8.php">TARJETA DE CRÉDITO/DÉBITO</option>
                                                <option value="pagospM8.php">TRANSFERENCIA INTERBANCARIA (SPEI)</option>
                                            </select>
                                        </form>
                                        ...
                                        function redireccionar() {
                                            ...
                                            if (selectedOption.value !== "ELIGE UNA OPCIÓN") {
