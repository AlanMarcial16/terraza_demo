...
if (isset($_POST['opcion'])) {
    ...
    // Inserción en ordenMesa6
    $sql = "INSERT INTO ordenMesa6 (nombre, cantidad, preciou, fyh) VALUES ('$opcion', '$cantidad', '$precio', '$fyh_actual')";
    $query = mysqli_query($con, $sql);

    // Inserción en ordenes_currentes
    $sql = "INSERT INTO ordenes_currentes (nombre, mesa, fyh) VALUES ('$opcion', 'Mesa 6', '$fyh_actual')";
    $query = mysqli_query($con, $sql);
