            ...
            <div class="container mt-5 custom-container">
                ...
                <!-- Mostrar los detalles de la mesa en la página -->
                            <div style="text-align: left;">
                                ...
                                <h1 class="title"><b>Detalles de la Mesa 6</b></h1>
                                <br>
                            </div>
                                <br><br><br>
                                    <hr>
                                    ...
                                    <div class="col">
                                            ...
                                            <script type="text/javascript">
                                                        ...
                                                        if (result.isConfirmed) {
                                                            ...
                                                            if (result.isConfirmed) {
                                                                ...
                                                                window.location.href = 'reiniciar_mesa6.php';
                                                            }
                                                            });
                                                        }
                                                        })
                                        ...
                                        <!-- Modal para el menú -->
                                            ...
                                            <div class="modal-dialog" style="max-width: 800px;" role="document">
                                                ...
                                                <form action="procesar_formulario6.php" method="post">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1">
                                                    <div class="btn-group d-flex justify-content-center">
                                                        <form id="eliminar-form-<?php echo $row['id']; ?>" action="procesar_eliminar6.php" method="post">
                                                        ...
                                                        <!--<a href="editarticlem6.php?id=<?php echo $row['id']; ?>">
                                                            <button class="btn btn-sm btn-secondary"><i class="fa fa-pencil-square-o"></i></button>
                                                        </a>-->
                                                    </div>
                                                </td>
                                            ...
                                            <?php
                                                ...
                                                $querySum = "SELECT SUM(CAST(preciou AS DECIMAL(10,2))) AS total_preciou FROM ordenmesa6";
