...
<html lang="en">
    <head>
        <title>Dividir cuenta mesa 1 - Ocaso Terraza</title>
            ...
            <div class="container mt-5 custom-container">
                ...
                <div class="row">
                    ...
                    <div style="text-align: left;">
                                    ...
                                    <h1 style="text-align: center;"><b>Dividir cuenta - Mesa 1</b></h1>
                    </div>
                ...
                <!-- Mostrar los detalles de la mesa en la página -->
                                ...
                                <fieldset> 
                                    ...
                                    <div class="container">
                                        ...
                                        <form method="post" action="procesar_division.php">
                                            <table>
                                                <thead class="table-success table-striped">
                                                    <tr>
                                                        ...
                                                        <th class="thd" colspan="1">Dividir</th>
                                                    </tr>
                                                </thead>
                                                <?php
                                            ...
                                            <input class="btn btn-sm btn-success" type="submit" name="dividir" value="Dividir Cuenta">
                                        </form>
