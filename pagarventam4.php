            ...
            <div class="container mt-5 custom-container">
                ...
                <div class="row">
                    ...
                    <div style="text-align: left;">
                                    <a href="info_mesa4.php">
                                        <button class="btn btn-primary"><i class="fa1 fa fa-arrow-left"></i></button>
                                    </a>
                                    <h1 style="text-align: center;"><b>PAGAR - Mesa 4</b></h1>
                    </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <form id="myForm" style="max-width:500px;margin:auto">
                                            ...
                                            <select class="form-control mb-3" id="pago" name="pago" placeholder="Método de Pago" onchange="redireccionar()">
                                                ...
                                                <option value="pagoeM4.php">EFECTIVO</option>
                                                <option value="pagotM4.php">TARJETA DE CRÉDITO/DÉBITO</option>
                                                <option value="pagospM4.php">TRANSFERENCIA INTERBANCARIA (SPEI)</option>
                                            </select>
                                        </form>
