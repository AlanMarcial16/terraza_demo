...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="max-w-75">
                    <div class="container">
                      <h1 style="text-align: center"><b>Introduzca los datos de la mesa a Reservar</b></h1>
                      <br>
                    <?php
                    ...
                    if ($resultado->num_rows == 1) {
                      ...
                      <form method='POST' action='actualizar_mesas.php' class='flat-form'>
                      ...
                      <div class='form-group'>
                        ...
                        <input type='number' class='form-control' name='capacidad' id='capacidad' value='<?php echo $capacidad; ?>' required>
                      </div>
                      <div class='form-group'>
