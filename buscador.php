...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    // Verificar si se han recibido los términos de búsqueda del formulario
    if(isset($_POST['busqueda'])) {
        // Sanitizar los términos de búsqueda para evitar inyecciones SQL
        $termino_busqueda = mysqli_real_escape_string($con, $_POST['busqueda']);

        // Consulta MySQL para buscar registros que contengan el término de búsqueda en el campo 'nombre'
        $sql = "SELECT * FROM tickets WHERE comensal LIKE '%$termino_busqueda%'";
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 class="h1"><b>Tickets - Búsqueda por nombre</b></h1>
