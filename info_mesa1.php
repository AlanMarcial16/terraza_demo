            ...
            <div class="container mt-5 custom-container">
                ...
                <!-- Mostrar los detalles de la mesa en la página -->
                            <div style="text-align: left;">
                                ...
                                <h1 class="title"><b>Detalles de la Mesa 1</b></h1>
                                <br>
                            </div>
                                <br><br><br>
                                    <hr>
                                    ...
                                    ?>
                                    <div class="col">
                                            <h5 for="selector1-<?php echo $row['id'] ?>">Comensal</h5>
                                            <input type="int" class="form-control" value="<?php echo $row['comensal'] ?>" readonly>
                                            <br>
                                            ...
                                            <script type="text/javascript">
                                                        ...
                                                        if (result.isConfirmed) {
                                                            ...
                                                            if (result.isConfirmed) {
                                                                ...
                                                                window.location.href = 'reiniciar_mesa1.php';
                                                            }
                                                            });
                                                        }
                                                        })
                                        ...
                                        <!-- Modal para el menú -->
                                            ...
                                            <div class="modal-dialog" style="max-width: 800px;" role="document">
                                                ...
                                                <form action="procesarform1.php" method="post">
                                                    ...
                                                    <div class="grid-container">
                                                        ...
                                                        <div class="grid-item">
                                                        <input id="boton-imagen" type="image" src="https://cdn-icons-png.flaticon.com/512/2405/2405451.png" alt="Botón de imagen" 
                                                        onclick="seleccionarOpcion('mezcal destilado de mole 375 ml', '1', '566')">
                                                            <p>mezcal destilado de mole 375 ml</p>
                                                        </div>
                                                        <div class="grid-item">
                                                        <input id="boton-imagen" type="image" src="https://cdn-icons-png.flaticon.com/512/2405/2405451.png" alt="Botón de imagen" 
                                                        onclick="seleccionarOpcion('mezcal destilado de mole copa', '1', '95')">
                                                            <p>mezcal destilado de mole copa</p>
                                                        </div>
                                        ...
                                        <!--<script>
                                        var audio = new Audio("sounds/xdxd.mp3");
                                        audio.play();
                                        </script>-->
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1">
                                                    <div class="btn-group d-flex justify-content-center">
                                                        <form id="eliminar-form-<?php echo $row['id']; ?>" action="procesar_eliminar.php" method="post">
                                                        ...
                                                        <!--<a href="editarticlem1.php?id=<?php echo $row['id']; ?>">
                                                            <button class="btn btn-sm btn-secondary"><i class="fa fa-pencil-square-o"></i></button>
                                                        </a>-->
                                                    </div>
                                                </td>
                                            ...
                                            <?php
                                                ...
                                                $querySum = "SELECT SUM(CAST(preciou AS DECIMAL(10,2))) AS total_preciou FROM ordenmesa1";
