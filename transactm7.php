...
$conn7 = mysqli_connect($servername, $username, $password, "pruebar");
...
// Obtener la habitación de Mesa 7 de la base de datos "pruebar"
...
if (mysqli_num_rows($result) > 0) {
    ...
    if (mysqli_num_rows($resultReservaciones) > 0) {
        ...
        // Consulta SQL para obtener la suma de 'preciou' de la tabla 'ordenmesa7' en la base de datos "pruebar"
        ...
        if (mysqli_num_rows($resultTotal) > 0) {
            ...
            echo "No se pudo obtener el valor de 'total' desde la tabla 'ordenmesa7' en la base de datos 'pruebar'.";
        }
    ...
    echo "No se encontró la habitación 'Mesa 7' en la tabla 'mesas' de la base de datos 'pruebar'.";
}
?>
