...
// Consulta para obtener los datos de la tabla ordenMesa7
...
if (mysqli_num_rows($result) > 0) {
    ...
    $sql_habitacion = "SELECT habitacion, comensal FROM mesas WHERE nombre = 'Mesa 7'";
    $result_habitacion = mysqli_query($conn7, $sql_habitacion);
    ...
    if (mysqli_num_rows($result_habitacion) > 0) {
        ...
        if (mysqli_query($conn, $insert_query)) {
            ...
            // Redirige a la página "mandarhabm7.php"
            header("Location: endpdM7.php");
