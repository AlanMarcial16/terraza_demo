...
<head>
    <meta charset="UTF-8">
    <title>Login JEFE DE OPERACIONES - Casa Flora Handmade Hotel</title>
...
<div class="login">
    ...
    <h1 class="login-header">Inicio de sesión JEFE DE OPERACIONES</h1>
    ...
    <p>Por favor, introduzca sus credenciales para iniciar sesión.</p>
        ...
        <p><a href="index.php">Volver a incio de sesión</a></p>
