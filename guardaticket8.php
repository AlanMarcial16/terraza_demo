...
// Consulta para obtener los datos de la tabla ordenMesa8
...
if (mysqli_num_rows($result) > 0) {
    ...
    $sql_habitacion = "SELECT habitacion, comensal FROM mesas WHERE nombre = 'Mesa 8'";
    $result_habitacion = mysqli_query($conn8, $sql_habitacion);
    ...
    if (mysqli_num_rows($result_habitacion) > 0) {
        ...
        if (mysqli_query($conn, $insert_query)) {
            ...
            // Redirige a la página "reiniciar_mesa8.php"
            header("Location: reiniciar_mesa8.php");
