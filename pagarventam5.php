            ...
            <div class="container mt-5 custom-container">
                ...
                <div class="row">
                    ...
                    <div style="text-align: left;">
                                    ...
                                    <h1 style="text-align: center;"><b>PAGAR - Mesa 5</b></h1>
                    </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <form id="myForm" style="max-width:500px;margin:auto">
                                            ...
                                            <select class="form-control mb-3" id="pago" name="pago" placeholder="Método de Pago" onchange="redireccionar()">
                                                ...
                                                <option value="pagoeM5.php">EFECTIVO</option>
                                                <option value="pagotM5.php">TARJETA DE CRÉDITO/DÉBITO</option>
                                                <option value="pagospM5.php">TRANSFERENCIA INTERBANCARIA (SPEI)</option>
                                            </select>
                                        </form>
