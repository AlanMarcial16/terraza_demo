...
if (isset($_POST['opcion'])) {
    ...
    // Inserción en ordenMesa2
    $sql = "INSERT INTO ordenMesa2 (nombre, cantidad, preciou, fyh) VALUES ('$opcion', '$cantidad', '$precio', '$fyh_actual')";
    $query = mysqli_query($con, $sql);

    // Inserción en ordenes_currentes
    $sql = "INSERT INTO ordenes_currentes (nombre, mesa, fyh) VALUES ('$opcion', 'Mesa 2', '$fyh_actual')";
    $query = mysqli_query($con, $sql);
