...
// Consulta para obtener la suma de 'preciou' en la tabla 'ordenmesa3' de la base de datos 'pruebar_demo'
$sqlSuma = "SELECT SUM(preciou) AS total FROM pruebar_demo.ordenmesa3";
...
header("Location: reiniciar_mesa3.php");
exit;
?>
