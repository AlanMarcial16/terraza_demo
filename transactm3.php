...
// Obtener la habitación de Mesa 3 de la base de datos "pruebar"
...
if (mysqli_num_rows($result) > 0) {
    ...
    if (mysqli_num_rows($resultReservaciones) > 0) {
        ...
        // Consulta SQL para obtener la suma de 'preciou' de la tabla 'ordenmesa3' en la base de datos "pruebar"
        ...
        if (mysqli_num_rows($resultTotal) > 0) {
            ...
            echo "No se pudo obtener el valor de 'total' desde la tabla 'ordenmesa3' en la base de datos 'pruebar'.";
        }
