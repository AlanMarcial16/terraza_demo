...
// Consulta para obtener los datos de la tabla ordenMesa2
...
if (mysqli_num_rows($result) > 0) {
    ...
    $sql_habitacion = "SELECT habitacion, comensal FROM mesas WHERE nombre = 'Mesa 2'";
    $result_habitacion = mysqli_query($conn2, $sql_habitacion);
    ...
    if (mysqli_num_rows($result_habitacion) > 0) {
        ...
        if (mysqli_query($conn, $insert_query)) {
            ...
            // Redirige a la página "reiniciar_mesa2.php"
            header("Location: reiniciar_mesa2.php");
